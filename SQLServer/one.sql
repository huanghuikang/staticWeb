USE [ekp]
GO
/****** Object:  StoredProcedure [dbo].[yufukuan_fukuan]    Script Date: 11/05/2018 08:48:07 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	set @sqlstr='select RANK() OVER(ORDER BY t2.fd_name) AS 序号,t2.fd_name as '+  '部门名称,t1.fmounthz as 汇总金额,' + @sqlname +  ' from tongjifeiyongs t1 inner join  sys_org_element t2 on t2.fd_id=t1.forgid '
	exec(@sqlstr)
